...
| **Colab-First Workflow** | Notebook-first workflow for data preparation, model training, cached evaluation, and an end-to-end pipeline demo |
...
3. Execute the notebooks in order:
   ...
   - `02_train_hccs.ipynb`
   - `05_cached_generation_evaluation.ipynb`
   - `03_evaluation.ipynb`
...
│   ├── 05_cached_generation_evaluation.ipynb # Official cached evaluation matrix
│   ├── 03_evaluation.ipynb         # Legacy exploratory evaluation
...
- **Need the full project summary?** Read [`docs/PROJECT_SUMMARY.md`](docs/PROJECT_SUMMARY.md).
...
- **Running evaluation?** Use [`docs/EVALUATION_PROTOCOL.md`](docs/EVALUATION_PROTOCOL.md) and `notebooks/05_cached_generation_evaluation.ipynb`.
- **Need plain-English terms?** Read [`docs/GLOSSARY.md`](docs/GLOSSARY.md).
- **Running the full workflow?** Start in `notebooks/01_data_pipeline.ipynb`, train with `02_train_hccs.ipynb`, evaluate with `05_cached_generation_evaluation.ipynb`, then demo with `04_pipeline_demo.ipynb`.
